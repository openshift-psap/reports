...
aws iam put-role-policy --role-name "$ROLE_NAME" --policy-name psap-reports-token-admin-data --policy-document "{\"Version\":\"2012-10-17\",\"Statement\":[{\"Effect\":\"Allow\",\"Action\":[\"s3:GetObject\",\"s3:PutObject\"],\"Resource\":\"arn:aws:s3:::$S3_BUCKET/tokens.json\"},{\"Effect\":\"Allow\",\"Action\":[\"s3:GetObject\",\"s3:PutObject\",\"s3:DeleteObject\"],\"Resource\":[\"arn:aws:s3:::$S3_BUCKET/report-meta/*\",\"arn:aws:s3:::$S3_BUCKET/report-index/*\",\"arn:aws:s3:::$S3_BUCKET/report-submissions/*\",\"arn:aws:s3:::$S3_BUCKET/public/*\",\"arn:aws:s3:::$S3_BUCKET/private/*\"]},{\"Effect\":\"Allow\",\"Action\":\"s3:ListBucket\",\"Resource\":\"arn:aws:s3:::$S3_BUCKET\",\"Condition\":{\"StringLike\":{\"s3:prefix\":[\"report-meta/*\",\"report-index/*\",\"public/*\",\"private/*\"]}}}]}"
